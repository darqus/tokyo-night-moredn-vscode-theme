...
const generateInterfaceColors = () => {
  const colors = {
    ...
    'terminal.findMatchBackground':
      interfacePalette.derived.findMatch.background,
    ...
    'terminalCommandDecoration.defaultBackground':
      interfacePalette.bg.hoverMuted,
    ...
    'terminal.ansiBrightBlack':
      interfacePalette.derived.terminal.ansiBrightBlack,
    'terminal.ansiBrightRed': interfacePalette.derived.terminal.ansiBrightRed,
    'terminal.ansiBrightGreen':
      interfacePalette.derived.terminal.ansiBrightGreen,
    ...
    'terminal.ansiBrightWhite':
      interfacePalette.derived.terminal.ansiBrightWhite,
    ...
    'extensionButton.prominentHoverBackground':
      interfacePalette.state.infoHover,
    ...
    'scmGraph.historyItemRefColor':
      interfacePalette.scmGraph.historyItemRefColor,
